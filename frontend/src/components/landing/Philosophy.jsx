      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="border border-emerald-500/40 rounded-2xl p-8 bg-gradient-to-br from-emerald-500/5 to-transparent backdrop-blur-sm hover:border-emerald-500/60 transition-all duration-300">
          ...
          <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-8">
            ...
            diberkali dengan skill yang dibutuhkan industri.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="border border-emerald-500/30 rounded-lg p-4 bg-emerald-500/5 hover:bg-emerald-500/10 transition-colors">
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 bg-yellow-400 rounded-full flex items-center justify-center text-black text-xs font-bold">💡</span>
                <h5 className="text-sm font-bold text-white">Problem Solving</h5>
              </div>
              <p className="text-xs text-gray-400">Critical thinking</p>
            </div>
            <div className="border border-emerald-500/30 rounded-lg p-4 bg-emerald-500/5 hover:bg-emerald-500/10 transition-colors">
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 bg-cyan-400 rounded-full flex items-center justify-center text-black text-xs font-bold">◎</span>
        ...
        <div className="flex flex-col gap-6">
          <div className="border border-yellow-500/40 rounded-2xl p-8 bg-gradient-to-br from-yellow-500/5 to-transparent backdrop-blur-sm hover:border-yellow-500/60 transition-all duration-300">
            <div className="flex items-center gap-3 mb-6">
          ...
          <div className="border border-yellow-500/40 rounded-2xl p-8 bg-gradient-to-br from-yellow-500/5 to-transparent backdrop-blur-sm">
            <div className="text-4xl md:text-6xl font-extrabold text-white mb-2">100%</div>
            <div className="text-xs md:text-sm text-gray-400 font-medium tracking-wide mb-4">Industry-Ready</div>
            <div className="text-sm md:text-base text-[#00F5A0] font-semibold">Siap kerja & mengajar</div>
          </div>
        </div>
      </div>
    </section>
